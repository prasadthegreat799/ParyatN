...
public class ToursAdapter extends FirebaseRecyclerAdapter<Model, ToursAdapter.Viewholder> {


    public ToursAdapter(@NonNull FirebaseRecyclerOptions<Model> options) {
    ...
    @Override
    protected void onBindViewHolder(@NonNull ToursAdapter.Viewholder holder, int position, @NonNull Model model) {
    ...
    @NonNull
    @Override
    public ToursAdapter.Viewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

        //the data objects are inflated into the xml file single_data_item
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.single_company_layout, parent, false);
        return new ToursAdapter.Viewholder(view);
